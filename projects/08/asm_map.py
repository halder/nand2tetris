ASM = {
    ...
    "C_CALL": {
        "single_file": [
            ...
            "D=A", "@SP", "M=M+1", "A=M-1", "M=D", "@LCL", "D=M", "@SP", "M=M+1", "A=M-1", "M=D", "@ARG", "D=M",
            "@SP", "M=M+1", "A=M-1", "M=D", "@THIS", "D=M", "@SP", "M=M+1", "A=M-1", "M=D", "@THAT", "D=M", "@SP", "M=M+1", "A=M-1",
            "M=D", "@R13", "D=M", "@5", "D=D+A", "@SP", "D=M-D", "@ARG", "M=D", "@SP", "D=M", "@LCL", "M=D", "@R14", "A=M", "0;JMP", "(%%FNAME%%$__FUNCTION_CALL)", "@%%FNAME%%", "0;JMP", "(%%FNAME%%$ret_%%CNT%%)"
        ],
        "multi_file": [
            "@%%NARG%%", "D=A", "@R13", "M=D", "@%%FNAME%%$__FUNCTION_CALL", "D=A", "@R14", "M=D", "@%%FNAME%%$ret_%%CNT%%",
    ...
    "C_RETURN": {
        "single_file": [
            "@LCL", "D=M", "@R13", "M=D", "@5", "A=D-A", "D=M", "@R14", "M=D", "@SP", "A=M-1", "D=M",
